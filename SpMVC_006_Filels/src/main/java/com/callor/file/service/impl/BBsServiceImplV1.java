...
public class BBsServiceImplV1 implements BBsService {
	 ...
	 * 원래 @Bean의 역할과 달리 TABLE을 생성하기 위한 코드로 변형
	 */
	@Autowired
	...
	/*
	 * 파일 포함한 Update
	 * 1. 새롭게 업로드된 대표 파일과 원래 Table에 저장된 파일이름 비교
	 * 2. 업로드된 파일과 Table에 저장된 파일이 서로 다르면
	 * 		업로드된 파일 삭제
	 * 3. 새로운 파일 업로드
