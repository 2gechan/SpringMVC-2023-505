...
@CrossOrigin(value = {"http://192.168.4.118:5500/", "*"})
@Slf4j
@Controller
public class HomeController {
	...
	public String detail(@ModelAttribute("BBS") BBsDto bbsDto,
			@RequestParam(value = "b_seq", required = false, defaultValue = "0") long b_seq, Model model) {
	...
	public String update(@RequestParam(value = "b_seq", required = false, defaultValue = "0") long b_seq,
			@ModelAttribute("BBS") BBsDto bbsDto, Model model) {
