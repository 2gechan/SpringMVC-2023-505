...
public class HomeController {
	...
	/*
	 * 문자열을 return 하여 views 폴더의 JSP와 Rendering 하는 절차를
	 * 생략하고
	 * 데이터를 있는 그대로 Client 에게 보내라
	 * CarDto 객체에 담긴 데이터를 JSON 객체로 변환하여
	 * Client로 전송하라
	 * pom.xml에 jackson-bind를 설치해 두어야 한다.
	 */
	@ResponseBody
	...
	public CarDto carDto() {
		...
		CarDto carDto = CarDto.builder().c_sdate(strDate).c_stime(strTime).c_username("chan").c_qty("시작")
